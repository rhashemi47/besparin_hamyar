                                ...
                                case 1://Profile
                                    ...
                                    if(coursors.getCount()>0)
                                    {
                                        ...
                                        if(Status_check.compareTo("0")==0)
                                        {
                                            ...
                                            {
                                                c.moveToNext();
                                                SyncProfile profile = new SyncProfile(YourCommitment.this, c.getString(c.getColumnIndex("guid")), c.getString(c.getColumnIndex("hamyarcode")));
                                    ...
                                    {
                                        Toast.makeText(YourCommitment.this, "برای استفاده از امکانات بسپارینا باید ثبت نام کنید", Toast.LENGTH_LONG).show();
...
//                                Toast.makeText(About.this, "تنظیمات", Toast.LENGTH_SHORT).show();
                                    AlertDialog.Builder alertbox = new AlertDialog.Builder(YourCommitment.this);
                                    ...
                                    alertbox.setPositiveButton("مراحل کاری", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface arg0, int arg1) {
                                            ...
                                            {
                                                c.moveToNext();
                                                SyncGetHmFactorService getHmFactorService=new SyncGetHmFactorService(YourCommitment.this,guid,hamyarcode);
                                    ...
                                    alertbox.setNegativeButton("ملزومات کاری", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface arg0, int arg1) {
                                            ...
                                            if(c.getCount()>0) {
                                                c.moveToNext();
                                                SyncGetHmFactorTools syncGetHmFactorTools=new SyncGetHmFactorTools(YourCommitment.this,guid,hamyarcode);
...
//                                Toast.makeText(About.this, "خروج از کاربری", Toast.LENGTH_SHORT).show();
                                    ...
                                    break;
                                case 14:
                                    Toast.makeText(YourCommitment.this, "تلگرام", Toast.LENGTH_SHORT).show();
                                    break;
                                case 15:
                                    Toast.makeText(YourCommitment.this, "اینستاگرام", Toast.LENGTH_SHORT).show();
                                    break;
                            }
                            return true;
                        }
