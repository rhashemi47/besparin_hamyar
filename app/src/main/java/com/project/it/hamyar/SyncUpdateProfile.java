...
public class SyncUpdateProfile {
	...
	private String regentCode;
	private boolean CuShowDialog=true;
	//Contractor
	public SyncUpdateProfile(Activity activity, String guid, String hamyarcode, String regentCode) {
	...
	public void CallWsMethod(String METHOD_NAME) {
		...
		//*****************************************************
		PropertyInfo regentCodePI = new PropertyInfo();
		//Set Name
		regentCodePI.setName("regentCode");
		//Set Value
		regentCodePI.setValue(this.regentCode);
		//Set dataType
		regentCodePI.setType(String.class);
		//Add the property to request object
		request.addProperty(regentCodePI);
		//*****************************************************
